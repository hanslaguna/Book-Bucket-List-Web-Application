...
function queryBooks() {
    ...
    request.onload = function () {
        ...
        for (var i = 0; i < 10; i++) {
            ...
            var description = (data["items"][i]["volumeInfo"]["description"]) || 'No description Disclosed'
